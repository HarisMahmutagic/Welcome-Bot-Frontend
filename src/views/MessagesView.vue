<template>
  <div id="MessageView">
    ...
    <div
      ...
      v-if="bluredScreen === false && extraClicked === false"
    >
      ?
    </div>
    ...
    <div
      id="extraButtonClicked"
      v-on:click="openExtra"
      v-if="bluredScreen === false && extraClicked === true"
    >
      ?
    </div>
    ...
    <div id="box1" v-on:click="turnOff" v-if="bluredScreen === false">
    ...
    <div id="box1Blur" v-on:click="turnOff" v-if="bluredScreen === true">
      <a id="title">Messages View !</a>
    ...
    <div id="createdOn" v-if="createSwitch != false">
      ...
      <form id="title1">
        ...
        <a
          class="mobTitle"
          v-if="title.length < 1 || title.length < 5 || title.length > 30"
          >X</a
        >
        <a
          class="mobTitleTrue"
    ...
    <div id="addButton" v-on:click="createNew" v-if="bluredScreen === false">
      Add
    </div>

    <!-- AddButton switch - For opening "CreatedON" div BLURED -->

    <div id="addButtonBlur" v-on:click="createNew" v-if="bluredScreen === true">
      Add
    </div>
  </div>
</template>
